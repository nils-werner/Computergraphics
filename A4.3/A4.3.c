...
{
	glPushMatrix();
	glTranslatef(1.8, 0.0, 0.0); // radius
	glRotatef(45.0, 0.0, 0.0, 0.0);  // rotation
...
void moon() 
{
	...
	glTranslatef(1.8, 0.0, 0.0); // radius
	glRotatef(45.0, 0.0, 0.0, 0.0);  // rotation
	glTranslatef(0.6, 0.0, 0.0); // radius zur erde
...
void mars() 
{
	...
	glTranslatef(3.0, 0.0, 0.0); // radius
	glRotatef(-30.0, 0.0, 0.0, 0.0);  // rotation
